package net.flashpunk
{
	...
	public class Screen
	{
		...
		public function Screen() 
		{
			...
			_bitmap[0] = new Bitmap(new BitmapData(FP.width/FP.minScale, FP.height/FP.minScale, false, 0), PixelSnapping.NEVER);
			_bitmap[1] = new Bitmap(new BitmapData(FP.width/FP.minScale, FP.height/FP.minScale, false, 0), PixelSnapping.NEVER);
